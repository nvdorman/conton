...
/// Conton: ChatGPT-mode auth tokens are CodeBuddy Global JWTs (RE login).
/// Model traffic goes to www.codebuddy.ai (chat completions path remapped in codex-api).
pub const CHATGPT_CODEX_BASE_URL: &str = "https://www.codebuddy.ai";
...
impl ModelProviderInfo {
    ...
    pub fn create_openai_provider(base_url: Option<String>) -> ModelProviderInfo {
        ModelProviderInfo {
            ...
            // Conton/CodeBuddy: no Responses WebSocket (wss://…/responses 404). HTTPS chat bridge only.
